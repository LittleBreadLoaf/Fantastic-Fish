...
public class EntityLobster extends EntityWaterMob
{
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.followRange).setAttribute(5);
	 ...
	 public boolean interact(EntityPlayer par1EntityPlayer)
	    {
		 	...
		 	if(item != null && item.itemID == FantasticItems.fishingNet.itemID)
		 	{
		 		...
		 		{
			 		lobsterDrop.setItemName(this.getCustomNameTag());
		 		}
