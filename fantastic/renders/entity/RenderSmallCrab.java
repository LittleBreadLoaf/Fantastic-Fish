...
public class RenderSmallCrab extends RenderLiving
{
	...
	private static final ResourceLocation texture1 = new ResourceLocation(FantasticInfo.ID.toLowerCase() + ":textures/models/mobs/smallcrab_blue.png");
    ...
    protected void scaleSmallCrab(EntitySmallCrab par1, float par2)
    {
        ...
        GL11.glTranslated(0.0, 0.85, 0.0);
