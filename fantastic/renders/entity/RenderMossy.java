...
{
	private static final ResourceLocation texture1 = new ResourceLocation(FantasticInfo.ID.toLowerCase() + ":textures/models/mobs/mossy_feeder.png");
	...
	protected void func_82430_a(EntityMossy par1, float par2, float par3, float par4)
    {
        ...
        {
            GL11.glTranslatef(0.0F, (float)(-par1.getRenderSize()), 0.0F);
        }
        else
        {
