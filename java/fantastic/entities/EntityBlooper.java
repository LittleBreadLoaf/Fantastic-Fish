...
public class EntityBlooper extends EntityWaterMob
{
    ...
    public EntityBlooper(World par1World)
    {
        super(par1World);
	 ...
	 public boolean interact(EntityPlayer par1EntityPlayer)
	    {
		 	...
		 	if(item != null && item.getItem() == FantasticItems.fishingNet)
		 	{
		 		...
		 		{
			 		squid.setStackDisplayName(this.getCustomNameTag());
		 		}
		 		EntityItem entityitem = new EntityItem(this.worldObj, this.posX, this.posY, this.posZ, squid);
		 		if(!this.worldObj.isRemote)
		 		{
