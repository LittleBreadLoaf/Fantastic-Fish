...
public class EntityFungus extends EntityWaterMob
{
	...
	public EntityFungus(World par1)
	{
		this(par1, rand.nextInt(5));
	}

	public EntityFungus(World par1World, int par3)
	{
		super(par1World);
	...
	protected void dropFewItems(boolean par1, int par2)
	{
		...
		this.entityDropItem(new ItemStack(Blocks.red_mushroom, rand.nextInt(2)), 0.0F);
		this.entityDropItem(new ItemStack(Blocks.brown_mushroom, rand.nextInt(2)), 0.0F);
		...
		if(FMLCommonHandler.instance().getEffectiveSide().isServer()){
			if(worldObj.getEntityByID(getBobberID()) instanceof EntityFishHook){
				...
				if(efh.field_146043_c != this){
					((EntityFungus)efh.field_146043_c).setBobberID(-1);
					efh.field_146043_c = this;
				}
			}
