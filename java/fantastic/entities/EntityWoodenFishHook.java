...
public class EntityWoodenFishHook extends EntityFishHook
{
    ...
    public EntityWoodenFishHook(World par1World)
    {
        super(par1World);
    ...
    @SideOnly(Side.CLIENT)
    public EntityWoodenFishHook(World par1World, double par2, double par4, double par6, EntityPlayer par8EntityPlayer)
    {
        this(par1World);
    ...
    public EntityWoodenFishHook(World par1World, EntityPlayer par2EntityPlayer)
    {
        super(par1World);
        this.field_146037_g = -1;
        this.field_146048_h = -1;
