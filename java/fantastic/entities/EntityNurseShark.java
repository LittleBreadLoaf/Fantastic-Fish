...
public class EntityNurseShark extends EntityFantasticFish
{
	//Textures
	...
	//CONSTRUCTOR
	public EntityNurseShark(World aWorld)
	{
		super(aWorld);
		InitializeAI();
	}
	...
	//CONSTRUCTOR
	public EntityNurseShark(World aWorld, FishSize aSize, int aTextureIndex, int isOutOfWater)
	{
		this(aWorld);
