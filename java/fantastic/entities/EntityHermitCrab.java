...
public class EntityHermitCrab extends EntityWaterMob
{

	private static Random rand = new Random();
	private boolean hasNotSpawned = true;

	public EntityHermitCrab(World par1)
	{
		this(par1, rand.nextInt(4));
	}

	public EntityHermitCrab(World par1World, int par2)
	{
		super(par1World);
	 ...
	 public boolean interact(EntityPlayer par1EntityPlayer)
	    {
		 	...
		 	{
		 		ItemStack crab = new ItemStack(FantasticItems.hermitCrab, 1);
		 		int damage = 5;
