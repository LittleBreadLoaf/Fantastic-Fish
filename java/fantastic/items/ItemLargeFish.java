...
public class ItemLargeFish extends Item
{
	@SideOnly(Side.CLIENT)
	public static IIcon[] icons;

	private static final String[] ICON = Names.LargeFish_UnlocalizedName;

	public ItemLargeFish()
	{
		super();
		this.maxStackSize = 1;
	...
	{
		return Names.LargeFish_UnlocalizedName[itemstack.getItemDamage()];
	}
    ...
    public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10)
    {
        ...
        else
        {
            ...
            {
            	EntitySalmon Fish = new EntitySalmon(par3World, 4, 0);
            	Fish.setLocationAndAngles((double)par4 + 0.5D, (double)par5 + d0, (double)par6 + 0.5D, 0, 0);
    			Fish.setRenderSize(1.3F);
    			Fish.setHasNotSpawned(false);
    			par3World.spawnEntityInWorld(Fish);
            ...
            {
            	EntitySalmon Fish = new EntitySalmon(par3World, 4, 1);
            	Fish.setLocationAndAngles((double)par4 + 0.5D, (double)par5 + d0, (double)par6 + 0.5D, 0, 0);
    			Fish.setRenderSize(1.3F);
    			Fish.setHasNotSpawned(false);
    			par3World.spawnEntityInWorld(Fish);
            ...
            else
            {
                if (movingobjectposition.typeOfHit == MovingObjectType.BLOCK)
                {
                    ...
                    if (par2World.getBlock(i, j, k).getMaterial() == Material.water)
                    {
                        ...
                        {
                        	EntitySalmon Fish = new EntitySalmon(par2World, 4, 0);
                        	Fish.setLocationAndAngles((double)i, (double)j, (double)k, 0, 0);
                			Fish.setRenderSize(1.3F);
                			Fish.setHasNotSpawned(false);
                			par2World.spawnEntityInWorld(Fish);
                        ...
                        {
                        	EntitySalmon Fish = new EntitySalmon(par2World, 4, 1);
                        	Fish.setLocationAndAngles((double)i, (double)j, (double)k, 0, 0);
                			Fish.setRenderSize(1.3F);
                			Fish.setHasNotSpawned(false);
                			par2World.spawnEntityInWorld(Fish);
