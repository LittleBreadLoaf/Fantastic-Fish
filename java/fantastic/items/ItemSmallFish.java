...
public class ItemSmallFish extends Item
{
 ...
 //        {
 //        	EntitySalmon Fish = new EntitySalmon(par3World, FishSize.Small, 1);
 //        	Fish.setLocationAndAngles((double)par4 + 0.5D, (double)par5 + d0, (double)par6 + 0.5D, 0, 0);
 //			Fish.setRenderSize(EntitySalmon.GetRenderValueFromSize(FishSize.Small));
 //			Fish.setHasNotSpawned(false);
 //			par3World.spawnEntityInWorld(Fish);
 //			
 //            if (Fish != null)
            ...
            else
            {
                if (movingobjectposition.typeOfHit == MovingObjectType.BLOCK)
                {
                    ...
                    if (par2World.getBlock(i, j, k).getMaterial() == Material.water)
                    {
                        ...
                        {
                        	EntitySalmon Fish = new EntitySalmon(par2World, FishSize.Small,_rand.nextInt(EntitySalmon.GetNumberOfTextures())+1,0);
                        	Fish.setLocationAndAngles((double)i, (double)j, (double)k, 0, 0);
                			//Fish.setRenderSize(0.5F);
                        	//Fish.currentSize=FishSize.Small;
                			//Fish.setHasNotSpawned(false);
                			par2World.spawnEntityInWorld(Fish);
                        ...
                        else if(par1ItemStack.getItemDamage() == 14)
                        {
                        	...
                        	EntityPike Fish = new EntityPike(par2World, FishSize.Small, _rand.nextInt(EntityPike.GetNumberOfTextures())+1,0);
                        	Fish.setLocationAndAngles((double)i, (double)j, (double)k, 0, 0);
