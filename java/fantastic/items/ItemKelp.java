...
public class ItemKelp extends Item
{
    ...
    public ItemKelp(Block par2Block)
    {
        super();
        this.setCreativeTab(FantasticItems.tabFantastic);
		this.setUnlocalizedName(Names.Kelp_UnlocalizedName);
    }
	@Override
	@SideOnly(Side.CLIENT)
	public void registerIcons(IIconRegister icon)
	{
		itemIcon = icon.registerIcon(FantasticInfo.ID.toLowerCase() + ":" + Names.Kelp_UnlocalizedName);
	}
    /**
    ...
    public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10)
    {
        ...
        {
            if (par3World.canPlaceEntityOnSide(FantasticBlocks.plantKelp, par4, par5, par6, false, par7, (Entity)null, par1ItemStack))
            {
                Block block = FantasticBlocks.plantKelp;
                ...
                {
                if (par3World.setBlock(par4, par5, par6, FantasticBlocks.plantKelp, j1, 3))
                {
                    if (par3World.getBlock(par4, par5, par6) == FantasticBlocks.plantKelp)
                    {
                        FantasticBlocks.plantKelp.onBlockPlacedBy(par3World, par4, par5, par6, par2EntityPlayer, par1ItemStack);
                        FantasticBlocks.plantKelp.onPostBlockPlaced(par3World, par4, par5, par6, j1);
                    }
