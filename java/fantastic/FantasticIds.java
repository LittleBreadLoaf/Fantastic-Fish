...
public class FantasticIds 
{
	...
	public static final int tinySpawnRate_Default = 60;
	
	public static int smallSpawnRate;
	public static final int smallSpawnRate_Default = 50;

	public static int mediumSpawnRate;
	public static final int mediumSpawnRate_Default = 40;
	
	public static int bigSpawnRate;
	public static final int bigSpawnRate_Default = 30;
	
	public static int largeSpawnRate;
	public static final int largeSpawnRate_Default = 20;
