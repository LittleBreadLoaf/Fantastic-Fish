...
public class Names 
{
	...
	public static final String TinyFish_UnlocalizedName[] = {"tgreenfishie", "tgreyfishie", "tredfishie", "tyellowfishie", "tbluefishie", "tpurplefishie", "tcavefishie", "tspottedfeeder", "tmossyfeeder", "ttuna", "tcatfish", "tsalmon", "tsalmon2", "tfungus", "tpike"};
	public static final String TinyFish_Name[] = {"Tiny Green Fish", "Tiny Grey Fish", "Tiny Red Fish", "Tiny Yellow Fish", "Tiny Blue Fish", "Tiny Purple Fish", "Tiny Cave Fish", "Tiny Spotted Bottom Feeder", "Tiny Mossy Bottom Feeder", "Tiny Tuna", "Tiny Catfish", "Tiny Grey Salmon", "Tiny Red Salmon", "Tiny Fungus Fish", "Tiny Pike"};
	public static final String SmallFish_UnlocalizedName[] = {"sgreenfishie", "sgreyfishie", "sredfishie", "syellowfishie", "sbluefishie", "spurplefishie", "scavefishie", "sspottedfeeder", "smossyfeeder", "stuna", "scatfish", "ssalmon", "ssalmon2", "sfungus","spike"};
	public static final String SmallFish_Name[] = {"Small Green Fish", "Small Grey Fish", "Small Red Fish", "Small Yellow Fish", "Small Blue Fish", "Small Purple Fish", "Small Cave Fish", "Small Spotted Bottom Feeder", "Small Mossy Bottom Feeder", "Small Tuna", "Small Catfish", "Small Grey Salmon", "Small Red Salmon", "Small Fungus Fish","Small Pike"};
	public static final String MediumFish_UnlocalizedName[] = {"mgreenfishie", "mgreyfishie", "mredfishie", "myellowfishie", "mbluefishie", "mpurplefishie", "mcavefishie", "mspottedfeeder", "mmossyfeeder", "mtuna", "mcatfish", "msalmon", "msalmon2", "mfungus","mpike"};
	public static final String MediumFish_Name[] = {"Medium Green Fish", "Medium Grey Fish", "Medium Red Fish", "Medium Yellow Fish", "Medium Blue Fish", "Medium Purple Fish", "Medium Cave Fish", "Medium Spotted Bottom Feeder", "Medium Mossy Bottom Feeder", "Medium Tuna", "Medium Catfish", "Medium Grey Salmon", "Medium Red Salmon", "Medium Fungus Fish","Medium Pike"};
	public static final String BigFish_UnlocalizedName[] = {"bgreenfishie", "bgreyfishie", "bredfishie", "byellowfishie", "bbluefishie", "bpurplefishie", "bcavefishie", "bspottedfeeder", "bmossyfeeder", "btuna", "bcatfish", "bsalmon", "bsalmon2", "bfungus","bpike"};
