...
public class ItemDiverHelmet extends ItemArmor 
{

	public ItemDiverHelmet(ArmorMaterial par2, int par3, int par4) 
	{
		super(par2, par3, par4);
		this.setUnlocalizedName(Names.DiverHelm_UnlocalizedName);
		this.setTextureName(FantasticInfo.ID + ":" + Names.DiverHelm_UnlocalizedName);
	...
	{
		this.itemIcon = par1RegisterIcon.registerIcon(FantasticInfo.ID.toLowerCase() + ":" + Names.DiverHelm_UnlocalizedName);
	}
	
	@Override
	public String getArmorTexture(ItemStack stack, Entity entity, int slot, String layer)
	{
		return FantasticInfo.ID.toLowerCase() + ":textures/models/armor/diver_helm.png";
	}
	...
	public ModelBiped getArmorModel(EntityLivingBase entityLiving, ItemStack itemStack, int armorSlot) 
	{
		...
		if(itemStack != null)
		{
				armorModel = FantasticMod.proxy.getArmorModel(5);
				if(armorModel != null){
