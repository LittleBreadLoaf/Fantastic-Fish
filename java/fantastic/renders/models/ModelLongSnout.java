...
public class ModelLongSnout extends ModelBase
{
  ...
  public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity entity)
  {
    ...
    this.bodysegment1.rotateAngleY = 0.24F *(MathHelper.cos(f2 * sizeChange * 0.527F) );
    this.bodysegment2.rotateAngleY = 0.2F  *(MathHelper.cos(f2 * sizeChange * 0.527F - (float)(Math.PI/6)) );
    this.bodysegment3.rotateAngleY = 0.18F *(MathHelper.cos(f2 * sizeChange * 0.527F - (float)(Math.PI/3)) );
    this.bodysegment4.rotateAngleY = 0.16F *(MathHelper.cos(f2 * sizeChange * 0.527F - (float)(Math.PI/2)) );
    this.bodysegment5.rotateAngleY = 0.14F *(MathHelper.cos(f2 * sizeChange * 0.527F - (float)(2*Math.PI/3)) );
    this.bodysegment6.rotateAngleY = 0.12F *(MathHelper.cos(f2 * sizeChange * 0.527F - (float)(5*Math.PI/6)) );
  }
