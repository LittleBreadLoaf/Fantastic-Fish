...
public class RenderCaveFish extends RenderLiving
{
	...
	//private static final ResourceLocation texture2 = new ResourceLocation(FantasticInfo.ID.toLowerCase() + ":textures/models/mobs/CaveFish2.png");
	...
	{
		return ((EntityCaveFish)entity).GetTexture();
