...
public class RenderMossy extends RenderLiving
{
	//private static final ResourceLocation texture1 = new ResourceLocation(FantasticInfo.ID.toLowerCase() + ":textures/models/mobs/Mossy.png");
	//private static final ResourceLocation texture2 = new ResourceLocation(FantasticInfo.ID.toLowerCase() + ":textures/models/mobs/Mossy2.png");

	protected ModelBasicFish model;

	public RenderMossy(ModelBase par1ModelBase, float par2)
	{
		super(par1ModelBase, par2);
		model = ((ModelBasicFish) mainModel);
	}

	public void renderMossy(EntityMossy par1, double par2, double par3, double par4, float par5, float par6)
	{
	...
	{
		this.renderMossy((EntityMossy) par1, par2, par3, par4, par5, par6);
	...
	{
		return ((EntityMossy)entity).GetTexture();
    ...
    {
        this.scaleFish((EntityMossy)par1EntityLivingBase, par2);
    }
    
    protected void scaleFish(EntityMossy par1, float par2)
    {
	...
	protected void func_82430_a(EntityMossy par1, float par2, float par3, float par4)
    {		
		float par6 = 0;
    ...
    {
        this.func_82430_a((EntityMossy)par1EntityLivingBase, par2, par3, par4);
