...
public class RenderMusky extends RenderLiving
{

	protected ModelPike model;

	public RenderMusky(ModelBase par1ModelBase, float par2)
	{
		super(par1ModelBase, par2);
		model = ((ModelPike) mainModel);
	}

	public void renderMusky(EntityMusky par1, double par2, double par3, double par4, float par5, float par6)
	{
	...
	{
		this.renderMusky((EntityMusky) par1, par2, par3, par4, par5, par6);
	...
	{
		return ((EntityMusky)entity).GetTexture();
    ...
    {
        this.scaleFish((EntityMusky)par1EntityLivingBase, par2);
    }
    
    protected void scaleFish(EntityMusky par1, float par2)
    {
    ...
    {
        this.func_82430_a((EntityMusky)par1EntityLivingBase, par2, par3, par4);
