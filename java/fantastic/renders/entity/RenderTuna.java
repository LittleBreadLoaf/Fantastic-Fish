...
{
	//private static final ResourceLocation texture1 = new ResourceLocation(FantasticInfo.ID.toLowerCase() + ":textures/models/mobs/Tuna.png");
	//private static final ResourceLocation texture2 = new ResourceLocation(FantasticInfo.ID.toLowerCase() + ":textures/models/mobs/Tuna2.png");
	...
	public void renderTuna(EntityTuna par1, double par2, double par3, double par4, float par5, float par6)
	{
	...
	{
		this.renderTuna((EntityTuna) par1, par2, par3, par4, par5, par6);
	...
	{
		return ((EntityTuna)entity).GetTexture();
    ...
    {
        this.scaleFish((EntityTuna)par1EntityLivingBase, par2);
    }
    
    protected void scaleFish(EntityTuna par1, float par2)
    {
	...
	protected void func_82430_a(EntityTuna par1, float par2, float par3, float par4)
    {		
		float par6 = 0;
    ...
    {
        this.func_82430_a((EntityTuna)par1EntityLivingBase, par2, par3, par4);
