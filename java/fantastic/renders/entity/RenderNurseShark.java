...
public class RenderNurseShark extends RenderLiving
{
	...
	public RenderNurseShark(ModelBase par1ModelBase, float par2)
	{
		...
		model = ((ModelNurseShark) mainModel);
	}

	public void renderNurseShark(EntityNurseShark par1, double par2, double par3, double par4, float par5, float par6)
	{
	...
	{
		this.renderNurseShark((EntityNurseShark) par1, par2, par3, par4, par5, par6);
