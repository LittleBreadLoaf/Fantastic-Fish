...
public class RenderBarracuda extends RenderLiving
{

	protected ModelPike model;

	public RenderBarracuda(ModelBase par1ModelBase, float par2)
	{
		super(par1ModelBase, par2);
		model = ((ModelPike) mainModel);
	}

	public void renderBarracuda(EntityBarracuda par1, double par2, double par3, double par4, float par5, float par6)
	{
	...
	{
		this.renderBarracuda((EntityBarracuda) par1, par2, par3, par4, par5, par6);
	...
	{
		return ((EntityBarracuda)entity).GetTexture();
    ...
    {
        this.scaleFish((EntityBarracuda)par1EntityLivingBase, par2);
    }
    
    protected void scaleFish(EntityBarracuda par1, float par2)
    {
	...
	protected void func_82430_a(EntityBarracuda par1, float par2, float par3, float par4)
    {		
		float par6 = 0;
    ...
    {
        this.func_82430_a((EntityBarracuda)par1EntityLivingBase, par2, par3, par4);
