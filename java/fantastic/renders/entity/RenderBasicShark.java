...
public class RenderBasicShark extends RenderLiving
{
	...
	public void renderBasicShark(EntityFantasticShark par1, double par2, double par3, double par4, float par5, float par6)
	{
	...
	{
		this.renderBasicShark((EntityFantasticShark) par1, par2, par3, par4, par5, par6);
	...
	{
		return ((EntityFantasticShark)entity).GetTexture();
	}
    ...
    {
        this.scaleFish((EntityFantasticShark)par1EntityLivingBase, par2);
    }
    
    protected void scaleFish(EntityFantasticShark par1, float par2)
    {
	...
	protected void func_82430_a(EntityFantasticShark par1, float par2, float par3, float par4)
    {
		float par6 = 0;
    ...
    {
        this.func_82430_a((EntityFantasticShark)par1EntityLivingBase, par2, par3, par4);
